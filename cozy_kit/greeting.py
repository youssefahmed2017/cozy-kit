...
class Greeting:
    ...
    def bye(
            self,
            destination="Where ever you're gonna go",
    ) -> str:
        """
        ...
        message = (
            f"Bye {self.name}! "
            f"Have a nice day at {destination}!"
        )
    ...
    def good_evening(self) -> str:
        ...
        evenings_path = BASE_DIR / "jsons" / "evenings.json"
    ...
    def motivate(self) -> tuple[str, str]:
        """Returns a motivational quote."""
        motivations_path = BASE_DIR / "jsons" / "motivations.json"
    ...
    def add_motivation(
        ...
        """
        if not name.strip():
            raise errors.InvalidMotivationNameError(
                "Motivation name cannot be empty."
            )
    ...
    def add_fun_fact(
        ...
        """
        if not name.strip():
            raise errors.InvalidFunFactError(
                "Fun fact name cannot be empty."
            )
        ...
        fun_facts_path = BASE_DIR / "jsons" / "fun_facts.json"
    ...
    def holiday_greet(self) -> str:
        ...
        holidays_path = BASE_DIR / "jsons" / "holidays.json"
